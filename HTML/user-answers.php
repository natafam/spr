...
<body>
    ...
    <div>
        ...
        <div class="user-answers-main-container">


            <section class="user-answers-hero">
                ...
                <section class="user-answers-questions">

                    <div class="user-answers-heading">
                        <h2 class="user-answers-h2">Twoje odpowiedzi</h2>
                        <p class="user-answers-paragraph">
                            Tutaj znajdziesz wszystkie udzielone przez Ciebie odpowiedzi na pytania innych użytkowników.
                        </p>
                    </div>
