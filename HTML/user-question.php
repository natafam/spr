...
<html lang="pl-PL">
<head>
    <title>Twoje pytanie | StudyMateMatch</title>
    <meta charset="utf-8"/>
...
<body>
    ...
    <div>
        <link rel="stylesheet" href="../Styles/user-question.css"/>
        <div class="user-question-main-container">


            <section class="user-question-hero">
                ...
                <section class="user-question-questions">
                    <div class="user-question-heading">

                        <h2 class="user-question-text">Twoje pytanie</h2>
                        <p class="user-question-text1">To Twoje pytanie. Poczekaj chwilę aż ktoś na nie odpowie.</p>
