...
<html lang="pl-PL">
<head>
    <title>Kalendarz | StudyMateMatch</title>
    <meta charset="utf-8"/>
    ...
    <div>
        ...
        <div class="calendar-main-container">
            ...
            <section class="calendar-hero">
                ...
                <section class="calendar-question">
                    <div class="calendar-heading">
                        <h2 class="calendar-h2">Twój kalendarz</h2>
                        <p class="calendar-paragraph">Tutaj możesz zobaczyć swoje zaplanowane lekcje online wraz ze szczegółowymi informacjami.</p>
                        <p class="calendar-span">
                            <span>Aby móc korzystać z terminarza musisz być zalogowany. Jeśli nie jesteś, </span><a href="./login.php" class="calendar-navlink8">zaloguj się</a><span>, klikając tutaj.</span>
                        </p>
                    </div>
                </section>
