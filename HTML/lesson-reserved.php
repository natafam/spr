            ...
            <section class="question-sent-hero">
                ...
                <section class="question-sent">
                    <div class="question-sent-heading">
                        <h2 class="question-sent-h2">Lekcja zaplanowana!</h2>
                        <p class="question-sent-paragraph">Teraz musisz poczekać tylko na potwierdzenie lekcji przez Twojego nauczyciela. Zaplanowaną lekcję znajdziesz w swoim terminarzu.</p>
                    </div>
                </section>
